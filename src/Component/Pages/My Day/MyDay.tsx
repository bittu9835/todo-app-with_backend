...
const MyDay: FC<MyDayProps> = () => {
    ...
    const fetchData = () => {
        axios.get(`http://localhost:4000/api/notes/MyDay`, { headers })
            .then((response) => {
        ...
        //For completeData
        axios.get(`http://localhost:4000/api/notes/mydayconplete`, { headers })
            .then((response) => {
    ...
    const handleCheckOut = (todo: any) => {
        axios.delete(`http://localhost:4000/api/notes/${todo._id}/CkeckoutNotes`, { headers })
            .then((response) => {
                fetchData()
                toast.success(response.data.message)
            })
