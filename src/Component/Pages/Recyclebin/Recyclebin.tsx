...
const RecycleBin: FC<RecycleBinProps> = () => {
    ...
    const fetchData = () => {
        axios.get(`http://localhost:4000/api/notes/Recyclebin`, { headers })
            .then((response) => {
    ...
    const handleDelete = (todo: any) => {
        axios.delete(`http://localhost:4000/api/notes/${todo._id}/parmanentdelete`, { headers })
            .then((response) => {
                fetchData()
                setRender(!rander)
    ...
    const handleRestore = (todo: any) => {
        axios.delete(`http://localhost:4000/api/notes/${todo._id}/restore`, { headers })
            .then((response) => {
                fetchData()
                setRender(!rander)
                toast.success(response.data.message)
    ...
    const handleDeleteAll = () => {
        ...
        axios.delete(`http://localhost:4000/api/notes/parmanentdeleteall`, { headers })
            .then((response) => {
                fetchData()
                setRender(!rander)
                toast.success(response.data.message)
