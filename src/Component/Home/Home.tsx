...
const Home: FC<HomeProps> = () => {
    const { setEditForm, LeftNaveBar, darkMode, openEdit, setProfileToggle }: any = useContext(MyContext);
            ...
            <div className='w-screen h-screen bg-white transition-all duration-300'>
                ...
                <div className='h-[92vh] flex w-full relative'>
                    ...
                    <div onClick={() => {
                        setEditForm(false)
                        setProfileToggle()
                    }} className={`w-full  h-full ${darkMode ? 'bg-[#11100f] text-white shadow-gray-800' : 'bg-[#faf9f8] shadow-gray-300 shadow-inner'}   overflow-y-auto scrollbar-hide`}>
                        <Outlet />
                    </div>
